...
public class PersonManager {
	...
	private final String DB_URL      = "jdbc:oracle:thin:@<HOST>:<PORT>:<SID>"; // URL des Datenbanksystems
	private final String DB_USERNAME = "<USERNAME>"; // Nutzername
	private final String DB_PASSWORD = "<PASSWORD>"; // Passwort
